...
namespace ProjectMovie.Controllers
{
    public class UserController : Controller
    {
        ...
        [HttpPost]
        public ActionResult AddNewMovie(string Username, string movieName, HttpPostedFileBase moviePoster)
        {
            ...
            if (moviePoster != null)
            {
                var extension = Path.GetExtension(moviePoster.FileName);

                if (extension == ".jpg" || extension == ".png")
                {

                    var fileName = Path.GetFileName(moviePoster.FileName);
                    pFileName = fileName;
            ...
            var model = DatabaseProcesses.UserIntel(Username);
            DatabaseProcesses.AddNewMovie(Username, movieName, pFileName);
