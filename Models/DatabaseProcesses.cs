...
namespace ProjectMovie.Models
{
    public static class DatabaseProcesses
    {
        ...
        // NEW MOVIE
        public static void AddNewMovie(string userName, string movieName, string moviePoster)
        {
            ...
            using (var DB = new GottaRunContext())
            {
                ...
                newMovie = new Movie() { UserID = theUser.ID, Name = movieName, Poster = moviePoster };
